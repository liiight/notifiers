...
# vic.notify(rest_url='https://alert.victorops.com/integrations/generic/20131114/alert/f7dc2eeb-26dd-43b8-9ed2-0f08879f4ec2/cost_alerts',
#            message_type='CRITICAL',
#            entity_id='BA tesing',
#            entity_display_name="messege test header",
#            state_message="text in body",
#            annotations={"vo_annotate.i.Graph":"http://img.picturequotes.com/2/708/707644/funny-success-quote-1-picture-quote-1.jpg",
...
notify("victorops", rest_url='https://alert.victorops.com/integrations/generic/20131114/alert/f7dc2eeb-26dd-43b8-9ed2-0f08879f4ec2/cost_alerts',message_type='CRITICAL',entity_id='BA tesing',entity_display_name="messege test header",state_message="text in body",annotations={"vo_annotate.i.Graph":"http://img.picturequotes.com/2/708/707644/funny-success-quote-1-picture-quote-1.jpg","vo_annotate.s.Note":"'You can’t have everything. Where would you put it?' Steven Wright","vo_annotate.u.Runbook":"https://giphy.com/gifs/win-xNBcChLQt7s9a/fullscreen"})